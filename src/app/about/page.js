        ...
        <div className="bg-white py-24">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-10">
              {[
                { title: "Premium Quality", emoji: "💎", desc: "Every product is carefully selected & quality-checked." },
                { title: "Secure Checkout", emoji: "🔒", desc: "Your payments are safe and protected." },
                { title: "Fast Delivery", emoji: "🚚", desc: "Quick shipping with real-time tracking." },
                { title: "Friendly Support", emoji: "🤝", desc: "We’re always here when you need us." },
              ].map((item) => (
                <div
                  key={item.title}
