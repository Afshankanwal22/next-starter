export default function ShopByCategory() {
  const categories = [
    { name: "Electronics", items: 45, img: "/images/electronics.png" },
    { name: "Wearables", items: 23, img: "/images/wearables.png" },
    { name: "Bags", items: 34, img: "/images/bags.png" },
    { name: "Accessories", items: 56, img: "/images/accessories.png" },
    { name: "Footwear", items: 28, img: "/images/footwear.png" },
  ];
